...
List<Widget> buildPageIndicators(
    int totalPages, int currentPage, PageController _pageController, BuildContext context) {
  List<Widget> indicators = [];
  ...
  if (totalPages <= 4) {
    ...
    if (currentPage > 0 && currentPage < totalPages - 1) {
      indicators.add(buildIndicator(currentPage, _pageController, currentPage, context));
    }
    ...
    if (currentPage > totalPages - 2) {
      indicators.add(buildIndicator(totalPages - 2, _pageController, currentPage, context));
    }
    indicators.add(buildIndicator(totalPages - 1, _pageController, currentPage, context));
  }
...
Widget buildIndicator(
    int pageIndex, PageController _pageController, int currentPage, BuildContext context) {
